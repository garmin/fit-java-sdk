...
public class BarometerDataMesg extends Mesg   {
    ...
    static {
        ...
        barometerDataMesg.addField(new Field("enhanced_altitude", EnhancedAltitudeFieldNum, 134, 5, 500, "m", false, Profile.Type.UINT32));
    ...
    /**
     * @return number of enhanced_altitude
     */
    public int getNumEnhancedAltitude() {
     ...
     * Units: m
     *
     * @param index of enhanced_altitude
     * @return enhanced_altitude
     */
    public Float getEnhancedAltitude(int index) {
     ...
     */
    public void setEnhancedAltitude(int index, Float enhancedAltitude) {
        setFieldValue(3, index, enhancedAltitude, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
