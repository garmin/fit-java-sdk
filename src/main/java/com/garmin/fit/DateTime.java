...
public class DateTime implements Comparable<DateTime> {
    ...
    static final long OFFSET_MS = OFFSET;
    static final long OFFSET_S = OFFSET / 1000;
    ...
    public DateTime(java.util.Date date) {
        this.timestamp = (date.getTime() - OFFSET_MS) / 1000;
        this.fractional_timestamp = ((date.getTime() - OFFSET_MS) % 1000) / 1000.0;
    }
    ...
    public DateTime(Instant instant) {
        this.timestamp = instant.getEpochSecond() - OFFSET_S;
        this.fractional_timestamp = (instant.toEpochMilli() - OFFSET_MS) % 1000 / 1000.0;
    }
    ...
    public java.util.Date getDate() {
        ...
        return new java.util.Date((timestamp * 1000) + fractional_ms + OFFSET_MS);
    }
    ...
    public Instant getInstant() {
        ...
        return Instant.ofEpochMilli((timestamp * 1000) + fractional_ms + OFFSET_MS);
    }
