...
public class FitMessages {
    ...
    final List<BatteryMesg> batteryMesgs = new ArrayList<>();
    ...
    final List<NapEventMesg> napEventMesgs = new ArrayList<>();
    ...
    public List<BatteryMesg> getBatteryMesgs() {
        return Collections.unmodifiableList(batteryMesgs);
    }
    ...
    public List<NapEventMesg> getNapEventMesgs() {
