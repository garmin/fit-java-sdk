...
public class LapMesg extends Mesg implements MesgWithEvent   {
    ...
    public static final int NecLatFieldNum = 27;
    
    public static final int NecLongFieldNum = 28;
    
    public static final int SwcLatFieldNum = 29;
    
    public static final int SwcLongFieldNum = 30;
    ...
    public static final int ActiveTimeFieldNum = 70;
    
    public static final int WktStepIndexFieldNum = 71;
    
    public static final int AvgSwolfFieldNum = 73;
    ...
    public static final int AvgStrokesPerLengthFieldNum = 90;
    ...
    public static final int FrontGearShiftCountFieldNum = 96;
    
    public static final int RearGearShiftCountFieldNum = 97;
    ...
    public static final int MetabolicCaloriesFieldNum = 155;
    ...
    public static final int AvgGradeAdjustedSpeedFieldNum = 161;
    ...
    static {
        ...
        subfield_index++;
        lapMesg.fields.get(field_index).subFields.add(new SubField("total_pushes", 134, 1, 0, "pushes"));
        lapMesg.fields.get(field_index).subFields.get(subfield_index).addMap(25, 66);
        lapMesg.fields.get(field_index).subFields.get(subfield_index).addMap(25, 65);
        subfield_index++;
        field_index++;
        ...
        lapMesg.fields.get(field_index).subFields.get(subfield_index).addMap(25, 1);
        subfield_index++;
        lapMesg.fields.get(field_index).subFields.add(new SubField("avg_swimming_cadence", 2, 1, 0, "strokes/min"));
        lapMesg.fields.get(field_index).subFields.get(subfield_index).addMap(25, 5);
        subfield_index++;
        lapMesg.fields.get(field_index).subFields.add(new SubField("avg_paddlesport_cadence", 2, 1, 0, "strokes/min"));
        lapMesg.fields.get(field_index).subFields.get(subfield_index).addMap(25, 15);
        lapMesg.fields.get(field_index).subFields.get(subfield_index).addMap(25, 37);
        subfield_index++;
        lapMesg.fields.get(field_index).subFields.add(new SubField("avg_push_cadence", 2, 1, 0, "pushes/min"));
        lapMesg.fields.get(field_index).subFields.get(subfield_index).addMap(25, 66);
        lapMesg.fields.get(field_index).subFields.get(subfield_index).addMap(25, 65);
        subfield_index++;
        field_index++;
        ...
        lapMesg.fields.get(field_index).subFields.get(subfield_index).addMap(25, 1);
        subfield_index++;
        lapMesg.fields.get(field_index).subFields.add(new SubField("max_swimming_cadence", 2, 1, 0, "strokes/min"));
        lapMesg.fields.get(field_index).subFields.get(subfield_index).addMap(25, 5);
        subfield_index++;
        lapMesg.fields.get(field_index).subFields.add(new SubField("max_paddlesport_cadence", 2, 1, 0, "strokes/min"));
        lapMesg.fields.get(field_index).subFields.get(subfield_index).addMap(25, 15);
        lapMesg.fields.get(field_index).subFields.get(subfield_index).addMap(25, 37);
        subfield_index++;
        lapMesg.fields.get(field_index).subFields.add(new SubField("max_push_cadence", 2, 1, 0, "pushes/min"));
        lapMesg.fields.get(field_index).subFields.get(subfield_index).addMap(25, 66);
        lapMesg.fields.get(field_index).subFields.get(subfield_index).addMap(25, 65);
        subfield_index++;
        field_index++;
        ...
        field_index++;
        lapMesg.addField(new Field("nec_lat", NecLatFieldNum, 133, 1, 0, "semicircles", false, Profile.Type.SINT32));
        field_index++;
        lapMesg.addField(new Field("nec_long", NecLongFieldNum, 133, 1, 0, "semicircles", false, Profile.Type.SINT32));
        field_index++;
        lapMesg.addField(new Field("swc_lat", SwcLatFieldNum, 133, 1, 0, "semicircles", false, Profile.Type.SINT32));
        field_index++;
        lapMesg.addField(new Field("swc_long", SwcLongFieldNum, 133, 1, 0, "semicircles", false, Profile.Type.SINT32));
        field_index++;
        ...
        field_index++;
        lapMesg.addField(new Field("active_time", ActiveTimeFieldNum, 134, 1000, 0, "s", false, Profile.Type.UINT32));
        field_index++;
        lapMesg.addField(new Field("wkt_step_index", WktStepIndexFieldNum, 132, 1, 0, "", false, Profile.Type.MESSAGE_INDEX));
        field_index++;
        lapMesg.addField(new Field("avg_swolf", AvgSwolfFieldNum, 132, 1, 0, "", false, Profile.Type.UINT16));
        field_index++;
        ...
        field_index++;
        lapMesg.addField(new Field("avg_strokes_per_length", AvgStrokesPerLengthFieldNum, 132, 10, 0, "strokes / length", false, Profile.Type.UINT16));
        field_index++;
        ...
        field_index++;
        lapMesg.addField(new Field("front_gear_shift_count", FrontGearShiftCountFieldNum, 132, 1, 0, "", false, Profile.Type.UINT16));
        field_index++;
        lapMesg.addField(new Field("rear_gear_shift_count", RearGearShiftCountFieldNum, 132, 1, 0, "", false, Profile.Type.UINT16));
        field_index++;
        ...
        field_index++;
        lapMesg.addField(new Field("metabolic_calories", MetabolicCaloriesFieldNum, 132, 1, 0, "kcal", false, Profile.Type.UINT16));
        field_index++;
        ...
        field_index++;
        lapMesg.addField(new Field("avg_grade_adjusted_speed", AvgGradeAdjustedSpeedFieldNum, 134, 1000, 0, "m/s", false, Profile.Type.UINT32));
        field_index++;
    }
    ...
    public Long getTotalPushes() {
        return getFieldLongValue(10, 0, Profile.SubFields.LAP_MESG_TOTAL_CYCLES_FIELD_TOTAL_PUSHES);
    }
    ...
    public void setTotalPushes(Long totalPushes) {
        setFieldValue(10, 0, totalPushes, Profile.SubFields.LAP_MESG_TOTAL_CYCLES_FIELD_TOTAL_PUSHES);
    }
    ...
    public Short getAvgSwimmingCadence() {
        return getFieldShortValue(17, 0, Profile.SubFields.LAP_MESG_AVG_CADENCE_FIELD_AVG_SWIMMING_CADENCE);
    }
    ...
    public void setAvgSwimmingCadence(Short avgSwimmingCadence) {
        setFieldValue(17, 0, avgSwimmingCadence, Profile.SubFields.LAP_MESG_AVG_CADENCE_FIELD_AVG_SWIMMING_CADENCE);
    }
    ...
    public Short getAvgPaddlesportCadence() {
        return getFieldShortValue(17, 0, Profile.SubFields.LAP_MESG_AVG_CADENCE_FIELD_AVG_PADDLESPORT_CADENCE);
    }
     ...
     */
    public void setAvgPaddlesportCadence(Short avgPaddlesportCadence) {
        setFieldValue(17, 0, avgPaddlesportCadence, Profile.SubFields.LAP_MESG_AVG_CADENCE_FIELD_AVG_PADDLESPORT_CADENCE);
    }
     ...
     */
    public Short getAvgPushCadence() {
        return getFieldShortValue(17, 0, Profile.SubFields.LAP_MESG_AVG_CADENCE_FIELD_AVG_PUSH_CADENCE);
    }
     ...
     */
    public void setAvgPushCadence(Short avgPushCadence) {
        setFieldValue(17, 0, avgPushCadence, Profile.SubFields.LAP_MESG_AVG_CADENCE_FIELD_AVG_PUSH_CADENCE);
    }
    ...
    public Short getMaxSwimmingCadence() {
        return getFieldShortValue(18, 0, Profile.SubFields.LAP_MESG_MAX_CADENCE_FIELD_MAX_SWIMMING_CADENCE);
    }
     ...
     */
    public void setMaxSwimmingCadence(Short maxSwimmingCadence) {
        setFieldValue(18, 0, maxSwimmingCadence, Profile.SubFields.LAP_MESG_MAX_CADENCE_FIELD_MAX_SWIMMING_CADENCE);
    }
    ...
    public Short getMaxPaddlesportCadence() {
        return getFieldShortValue(18, 0, Profile.SubFields.LAP_MESG_MAX_CADENCE_FIELD_MAX_PADDLESPORT_CADENCE);
    }
     ...
     */
    public void setMaxPaddlesportCadence(Short maxPaddlesportCadence) {
        setFieldValue(18, 0, maxPaddlesportCadence, Profile.SubFields.LAP_MESG_MAX_CADENCE_FIELD_MAX_PADDLESPORT_CADENCE);
    }
     ...
     */
    public Short getMaxPushCadence() {
        return getFieldShortValue(18, 0, Profile.SubFields.LAP_MESG_MAX_CADENCE_FIELD_MAX_PUSH_CADENCE);
    }
     ...
     */
    public void setMaxPushCadence(Short maxPushCadence) {
        setFieldValue(18, 0, maxPushCadence, Profile.SubFields.LAP_MESG_MAX_CADENCE_FIELD_MAX_PUSH_CADENCE);
    }
    ...
    public void setNecLat(Integer necLat) {
        setFieldValue(27, 0, necLat, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public void setNecLong(Integer necLong) {
        setFieldValue(28, 0, necLong, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public void setSwcLat(Integer swcLat) {
        setFieldValue(29, 0, swcLat, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public void setSwcLong(Integer swcLong) {
        setFieldValue(30, 0, swcLong, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public Integer getAvgSwolf() {
        return getFieldIntegerValue(73, 0, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public void setAvgSwolf(Integer avgSwolf) {
        setFieldValue(73, 0, avgSwolf, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public void setAvgStrokesPerLength(Float avgStrokesPerLength) {
        setFieldValue(90, 0, avgStrokesPerLength, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public Integer getFrontGearShiftCount() {
        return getFieldIntegerValue(96, 0, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public void setFrontGearShiftCount(Integer frontGearShiftCount) {
        setFieldValue(96, 0, frontGearShiftCount, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public Integer getRearGearShiftCount() {
        return getFieldIntegerValue(97, 0, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public void setRearGearShiftCount(Integer rearGearShiftCount) {
        setFieldValue(97, 0, rearGearShiftCount, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public void setMetabolicCalories(Integer metabolicCalories) {
        setFieldValue(155, 0, metabolicCalories, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public Float getAvgGradeAdjustedSpeed() {
        return getFieldFloatValue(161, 0, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public void setAvgGradeAdjustedSpeed(Float avgGradeAdjustedSpeed) {
        setFieldValue(161, 0, avgGradeAdjustedSpeed, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
