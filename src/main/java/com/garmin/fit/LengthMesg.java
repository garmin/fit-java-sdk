...
public class LengthMesg extends Mesg implements MesgWithEvent   {
    ...
    public static final int MetabolicCaloriesFieldNum = 26;
    ...
    static {int field_index = 0;
        ...
        field_index++;
        lengthMesg.addField(new Field("metabolic_calories", MetabolicCaloriesFieldNum, 132, 1, 0, "kcal", false, Profile.Type.UINT16));
        field_index++;
    }
    ...
    public void setMetabolicCalories(Integer metabolicCalories) {
        setFieldValue(26, 0, metabolicCalories, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
