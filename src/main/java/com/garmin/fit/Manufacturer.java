...
public class Manufacturer  {
    ...
    public static final int ZEPP = 339;
    public static final int PELOTON = 340;
    public static final int CARV = 341;
    public static final int TISSOT = 342;
    public static final int REAL_VELO = 345;
    public static final int WETECH = 346;
    public static final int JESPR = 347;
    public static final int HUAWEI = 348;
    public static final int GOTOES = 349;
    public static final int CADENCE_APP = 350;
    public static final int UNA_WATCH = 351;
    public static final int TYMEWEAR = 352;
    public static final int EXPOSURE_LIGHTS = 353;
    public static final int FORTO_CYCLING = 354;
    ...
    static {
        ...
        stringMap.put(CADENCE_APP, "CADENCE_APP");
        stringMap.put(UNA_WATCH, "UNA_WATCH");
        stringMap.put(TYMEWEAR, "TYMEWEAR");
        stringMap.put(EXPOSURE_LIGHTS, "EXPOSURE_LIGHTS");
        stringMap.put(FORTO_CYCLING, "FORTO_CYCLING");
