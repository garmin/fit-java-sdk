...
public class Mesg {
    ...
    public BigDecimal[] getFieldBigDecimalValues(int num) {
        return getFieldBigDecimalValues(num, Fit.SUBFIELD_INDEX_ACTIVE_SUBFIELD);
    }

    public BigDecimal[] getFieldBigDecimalValues(int num, int subfieldIndex) {
        final Field field = getField(num);
    ...
    public BigDecimal[] getFieldBigDecimalValues(int num, String subfieldName) {
        final Field field = getField(num);
    ...
    public BigDecimal getFieldBigDecimalValue(int num) {
        return getFieldBigDecimalValue(num, 0, Fit.SUBFIELD_INDEX_ACTIVE_SUBFIELD);
    }

    public BigDecimal getFieldBigDecimalValue(int num, int fieldArrayIndex) {
        return getFieldBigDecimalValue(num, fieldArrayIndex, Fit.SUBFIELD_INDEX_ACTIVE_SUBFIELD);
    }

    public BigDecimal getFieldBigDecimalValue(int num, int fieldArrayIndex, int subFieldIndex) {
        final Field field = getField(num);
    ...
    public BigDecimal getFieldBigDecimalValue(int num, int fieldArrayIndex, String subFieldName) {
        final Field field = getField(num);
    ...
    public BigDecimal getFieldBigDecimalValue(String name) {
        return getFieldBigDecimalValue(name, 0);
    }

    public BigDecimal getFieldBigDecimalValue(String name, int fieldArrayIndex) {
        final Field field = getField(name, false);
