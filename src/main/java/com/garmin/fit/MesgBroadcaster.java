...
public class MesgBroadcaster implements MesgListener, MesgDefinitionListener, MesgSource {
    ...
    private final List<NapEventMesgListener> napEventMesgListeners;
    ...
    public MesgBroadcaster(Decode decode) {
        ...
        napEventMesgListeners = new ArrayList<NapEventMesgListener>();
    ...
    public void removeListener(BatteryMesgListener batteryMesgListener) {
        batteryMesgListeners.remove(batteryMesgListener);
    }
    ...
    public void addListener(NapEventMesgListener napEventMesgListener) {
        napEventMesgListeners.add(napEventMesgListener);
    }

    public void removeListener(NapEventMesgListener napEventMesgListener) {
    ...
    public void onMesg(final Mesg mesg) {
        ...
        case MesgNum.BATTERY:
            if (batteryMesgListeners.size() == 0) {
               break;
            }
        ...
        case MesgNum.SLEEP_DISRUPTION_OVERNIGHT_SEVERITY:
            ...
            break;
        case MesgNum.NAP_EVENT:
            if (napEventMesgListeners.size() == 0) {
               break;
            }

            final NapEventMesg napEventMesg = new NapEventMesg(mesg);
            for (final NapEventMesgListener mesgListener : napEventMesgListeners) {
