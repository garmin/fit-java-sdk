...
public class MonitoringMesg extends Mesg   {
    ...
    public static final int PushesFieldNum = 41;
    ...
    static {
        ...
        field_index++;
        monitoringMesg.addField(new Field("pushes", PushesFieldNum, 134, 1, 0, "", false, Profile.Type.UINT32));
        field_index++;
    }
     ...
     * Comment: Wheelchair Pushes
     *
     * @param pushes The new pushes value to be set
     */
    public void setPushes(Long pushes) {
        setFieldValue(41, 0, pushes, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
