...
public class SegmentLapMesg extends Mesg implements MesgWithEvent   {
    ...
    public static final int MetabolicCaloriesFieldNum = 88;
    ...
    static {
        ...
        field_index++;
        segmentLapMesg.addField(new Field("metabolic_calories", MetabolicCaloriesFieldNum, 132, 1, 0, "kcal", false, Profile.Type.UINT16));
        field_index++;
    ...
    public Integer getMetabolicCalories() {
        return getFieldIntegerValue(88, 0, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public void setMetabolicCalories(Integer metabolicCalories) {
        setFieldValue(88, 0, metabolicCalories, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
