...
public class SessionMesg extends Mesg implements MesgWithEvent   {
    ...
    public static final int MetabolicCaloriesFieldNum = 196;
    ...
    public static final int AvgGradeAdjustedSpeedFieldNum = 211;
    ...
    static {
        ...
        subfield_index = 0;
        sessionMesg.fields.get(field_index).subFields.add(new SubField("total_reps", 134, 1, 0, "reps"));
        sessionMesg.fields.get(field_index).subFields.get(subfield_index).addMap(6, 20);
        sessionMesg.fields.get(field_index).subFields.get(subfield_index).addMap(5, 62);
        subfield_index++;
        ...
        subfield_index++;
        sessionMesg.fields.get(field_index).subFields.add(new SubField("total_pushes", 134, 1, 0, "pushes"));
        sessionMesg.fields.get(field_index).subFields.get(subfield_index).addMap(5, 66);
        sessionMesg.fields.get(field_index).subFields.get(subfield_index).addMap(5, 65);
        subfield_index++;
        field_index++;
        ...
        sessionMesg.fields.get(field_index).subFields.get(subfield_index).addMap(5, 1);
        subfield_index++;
        sessionMesg.fields.get(field_index).subFields.add(new SubField("avg_swimming_cadence", 2, 1, 0, "strokes/min"));
        sessionMesg.fields.get(field_index).subFields.get(subfield_index).addMap(5, 5);
        subfield_index++;
        sessionMesg.fields.get(field_index).subFields.add(new SubField("avg_paddlesport_cadence", 2, 1, 0, "strokes/min"));
        sessionMesg.fields.get(field_index).subFields.get(subfield_index).addMap(5, 15);
        sessionMesg.fields.get(field_index).subFields.get(subfield_index).addMap(5, 37);
        subfield_index++;
        sessionMesg.fields.get(field_index).subFields.add(new SubField("avg_push_cadence", 2, 1, 0, "pushes/min"));
        sessionMesg.fields.get(field_index).subFields.get(subfield_index).addMap(5, 66);
        sessionMesg.fields.get(field_index).subFields.get(subfield_index).addMap(5, 65);
        subfield_index++;
        field_index++;
        ...
        sessionMesg.fields.get(field_index).subFields.get(subfield_index).addMap(5, 1);
        subfield_index++;
        sessionMesg.fields.get(field_index).subFields.add(new SubField("max_swimming_cadence", 2, 1, 0, "strokes/min"));
        sessionMesg.fields.get(field_index).subFields.get(subfield_index).addMap(5, 5);
        subfield_index++;
        sessionMesg.fields.get(field_index).subFields.add(new SubField("max_paddlesport_cadence", 2, 1, 0, "strokes/min"));
        sessionMesg.fields.get(field_index).subFields.get(subfield_index).addMap(5, 15);
        sessionMesg.fields.get(field_index).subFields.get(subfield_index).addMap(5, 37);
        subfield_index++;
        sessionMesg.fields.get(field_index).subFields.add(new SubField("max_push_cadence", 2, 1, 0, "pushes/min"));
        sessionMesg.fields.get(field_index).subFields.get(subfield_index).addMap(5, 66);
        sessionMesg.fields.get(field_index).subFields.get(subfield_index).addMap(5, 65);
        subfield_index++;
        field_index++;
        ...
        field_index++;
        sessionMesg.addField(new Field("active_time", ActiveTimeFieldNum, 134, 1000, 0, "s", false, Profile.Type.UINT32));
        field_index++;
        sessionMesg.addField(new Field("avg_strokes_per_length", AvgStrokesPerLengthFieldNum, 132, 10, 0, "strokes/length", false, Profile.Type.UINT16));
        field_index++;
        sessionMesg.addField(new Field("avg_swolf", AvgSwolfFieldNum, 132, 1, 0, "", false, Profile.Type.UINT16));
        field_index++;
        ...
        field_index++;
        sessionMesg.addField(new Field("num_segment_laps", NumSegmentLapsFieldNum, 132, 1, 0, "", false, Profile.Type.UINT16));
        field_index++;
        sessionMesg.addField(new Field("front_gear_shift_count", FrontGearShiftCountFieldNum, 132, 1, 0, "", false, Profile.Type.UINT16));
        field_index++;
        sessionMesg.addField(new Field("rear_gear_shift_count", RearGearShiftCountFieldNum, 132, 1, 0, "", false, Profile.Type.UINT16));
        field_index++;
        ...
        field_index++;
        sessionMesg.addField(new Field("metabolic_calories", MetabolicCaloriesFieldNum, 132, 1, 0, "kcal", false, Profile.Type.UINT16));
        field_index++;
        ...
        field_index++;
        sessionMesg.addField(new Field("avg_grade_adjusted_speed", AvgGradeAdjustedSpeedFieldNum, 134, 1000, 0, "m/s", false, Profile.Type.UINT32));
        field_index++;
    }
    ...
    public Long getTotalReps() {
        return getFieldLongValue(10, 0, Profile.SubFields.SESSION_MESG_TOTAL_CYCLES_FIELD_TOTAL_REPS);
    }
    ...
    public void setTotalReps(Long totalReps) {
        setFieldValue(10, 0, totalReps, Profile.SubFields.SESSION_MESG_TOTAL_CYCLES_FIELD_TOTAL_REPS);
    }
    ...
    public Long getTotalPushes() {
        return getFieldLongValue(10, 0, Profile.SubFields.SESSION_MESG_TOTAL_CYCLES_FIELD_TOTAL_PUSHES);
    }
    ...
    public void setTotalPushes(Long totalPushes) {
        setFieldValue(10, 0, totalPushes, Profile.SubFields.SESSION_MESG_TOTAL_CYCLES_FIELD_TOTAL_PUSHES);
    }
    ...
    public Short getAvgSwimmingCadence() {
        return getFieldShortValue(18, 0, Profile.SubFields.SESSION_MESG_AVG_CADENCE_FIELD_AVG_SWIMMING_CADENCE);
    }
    ...
    public void setAvgSwimmingCadence(Short avgSwimmingCadence) {
        setFieldValue(18, 0, avgSwimmingCadence, Profile.SubFields.SESSION_MESG_AVG_CADENCE_FIELD_AVG_SWIMMING_CADENCE);
    }
    ...
    public Short getAvgPaddlesportCadence() {
        return getFieldShortValue(18, 0, Profile.SubFields.SESSION_MESG_AVG_CADENCE_FIELD_AVG_PADDLESPORT_CADENCE);
    }
    ...
    public void setAvgPaddlesportCadence(Short avgPaddlesportCadence) {
        setFieldValue(18, 0, avgPaddlesportCadence, Profile.SubFields.SESSION_MESG_AVG_CADENCE_FIELD_AVG_PADDLESPORT_CADENCE);
    }
    ...
    public Short getAvgPushCadence() {
        return getFieldShortValue(18, 0, Profile.SubFields.SESSION_MESG_AVG_CADENCE_FIELD_AVG_PUSH_CADENCE);
    }
    ...
    public void setAvgPushCadence(Short avgPushCadence) {
        setFieldValue(18, 0, avgPushCadence, Profile.SubFields.SESSION_MESG_AVG_CADENCE_FIELD_AVG_PUSH_CADENCE);
    }
    ...
    public Short getMaxSwimmingCadence() {
        return getFieldShortValue(19, 0, Profile.SubFields.SESSION_MESG_MAX_CADENCE_FIELD_MAX_SWIMMING_CADENCE);
    }
    ...
    public void setMaxSwimmingCadence(Short maxSwimmingCadence) {
        setFieldValue(19, 0, maxSwimmingCadence, Profile.SubFields.SESSION_MESG_MAX_CADENCE_FIELD_MAX_SWIMMING_CADENCE);
    }
    ...
    public Short getMaxPaddlesportCadence() {
        return getFieldShortValue(19, 0, Profile.SubFields.SESSION_MESG_MAX_CADENCE_FIELD_MAX_PADDLESPORT_CADENCE);
    }
    ...
    public void setMaxPaddlesportCadence(Short maxPaddlesportCadence) {
        setFieldValue(19, 0, maxPaddlesportCadence, Profile.SubFields.SESSION_MESG_MAX_CADENCE_FIELD_MAX_PADDLESPORT_CADENCE);
    }
    ...
    public Short getMaxPushCadence() {
        return getFieldShortValue(19, 0, Profile.SubFields.SESSION_MESG_MAX_CADENCE_FIELD_MAX_PUSH_CADENCE);
    }
    ...
    public void setMaxPushCadence(Short maxPushCadence) {
        setFieldValue(19, 0, maxPushCadence, Profile.SubFields.SESSION_MESG_MAX_CADENCE_FIELD_MAX_PUSH_CADENCE);
    }
    ...
    public void setAvgStrokesPerLength(Float avgStrokesPerLength) {
        setFieldValue(79, 0, avgStrokesPerLength, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public Integer getAvgSwolf() {
        return getFieldIntegerValue(80, 0, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public void setAvgSwolf(Integer avgSwolf) {
        setFieldValue(80, 0, avgSwolf, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    /**
     * Get num_segment_laps field
     *
     * @return num_segment_laps
     */
    public Integer getNumSegmentLaps() {
        return getFieldIntegerValue(106, 0, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }

    /**
     * Set num_segment_laps field
     *
     * @param numSegmentLaps The new numSegmentLaps value to be set
     */
    public void setNumSegmentLaps(Integer numSegmentLaps) {
        setFieldValue(106, 0, numSegmentLaps, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public Integer getFrontGearShiftCount() {
        return getFieldIntegerValue(107, 0, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public void setFrontGearShiftCount(Integer frontGearShiftCount) {
        setFieldValue(107, 0, frontGearShiftCount, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public Integer getRearGearShiftCount() {
        return getFieldIntegerValue(108, 0, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public void setRearGearShiftCount(Integer rearGearShiftCount) {
        setFieldValue(108, 0, rearGearShiftCount, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public Float getAvgGradeAdjustedSpeed() {
        return getFieldFloatValue(211, 0, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    public void setAvgGradeAdjustedSpeed(Float avgGradeAdjustedSpeed) {
        setFieldValue(211, 0, avgGradeAdjustedSpeed, Fit.SUBFIELD_INDEX_MAIN_FIELD);
    }
