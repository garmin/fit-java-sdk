...
public enum SubSport  {
    ...
    BOULDERING((short)69),
    HIIT((short)70),
    INDOOR_GRINDING((short)71),
    HUNTING_WITH_DOGS((short)72),
    AMRAP((short)73),
    EMOM((short)74),
    TABATA((short)75),
    ESPORT((short)77),
    ...
    BRICK((short)80),
    SWIM_RUN((short)81),
    ADVENTURE_RACE((short)82),
    TRUCKER_WORKOUT((short)83),
    PICKLEBALL((short)84),
    PADEL((short)85),
    ...
    FLY_VFR((short)118),
    FLY_IFR((short)119),
    DYNAMIC_APNEA((short)121),
    ENDURO((short)123),
    RUCKING((short)124),
    RALLY((short)125),
    POOL_TRIATHLON((short)126),
    E_BIKE_ENDURO((short)127),
    ALL((short)254),
    INVALID((short)255);
